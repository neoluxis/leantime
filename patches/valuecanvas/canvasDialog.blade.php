...
<div class="" style="width:900px;">
    ...
    <form class="formModal" method="post" action="{{ BASE_URL }}/{{ $canvasName }}canvas/editCanvasItem/{{ $id }}">
        ...
        @if($dataLabels[1]['active'])
            <label>{!! __($dataLabels[1]['title'] . '.' . e($canvasItem['box'])) !!}</label>
        ...
        @if($dataLabels[2]['active'])
            <label>{!! __($dataLabels[2]['title'] . '.' . e($canvasItem['box'])) !!}</label>
        ...
        @if($dataLabels[3]['active'])
            <label>{!! __($dataLabels[3]['title'] . '.' . e($canvasItem['box'])) !!}</label>
        ...
        @if($id !== '')
            ...
            @else
                    <li class="ui-state-default" id="milestone_{{ $canvasItem['milestoneId'] }}" class="{{ $canvasName }}CanvasMilestone">
                        <div hx-trigger="load"
